    ...
    public class PoliticalParty
    {
        ...
        public void AddIdeology(Ideology ideology)
        {
            if (Members.Contains(ideology))
                throw new Exception($"Cannot add {ideology.Name} in game {ideology.Nation.Game.Id} to party {this.Name}. That ideology is already in that party.");
        ...
        {
            if (!Members.Contains(ideology))
                throw new Exception($"Cannot add {ideology.Name} in game {ideology.Nation.Game.Id} to party {this.Name}. That ideology is not in that party.");
