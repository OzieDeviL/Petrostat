...
namespace Petrostat.Domain.Ideologies
{
    internal class PartyChallenge : PolicyChoice
    {
        ...
        protected override List<PolicyChoiceRequirement> MinimumRequirementCombinations
        {
            get
            {
                var requirementsEnums = new List<PolicyChoiceRequirement>
                {
                    ...
                    |   PolicyChoiceRequirement.BeNonLeadingPartyMember
                };
        ...
        protected override PolicyChoiceRequirement GetCurrentQualifications(Ideology ideology)
        {
            ...
            qualifications |= (ideology.CurrentParty != null && ideology.CurrentParty.Leader != ideology) ? PolicyChoiceRequirement.BeNonLeadingPartyMember : PolicyChoiceRequirement.None;           
