...
{
    internal class ReligiousLawRemove : TargetedPolicyChoice<Population>
    {

        public override PolicyName Name { get => PolicyName.ReligiousLawRemove; }
        public override void Play()
        {
            throw new NotImplementedException();
        }
        public override string Description => "Remove a religious law token to or from 1 of your aligned population or army markers. Government player may add or remove 1 religious law tokens to or from any population or army marker.";
        ...
        protected override List<PolicyChoiceTargetRequirement> MinimumTargetRequirementCombinations
        {
            get
            {
                ...
                {
                        PolicyChoiceTargetRequirement.UnderReligiousLaw                    
